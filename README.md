...
```bash
git clone https://github.com/LazyPanda902/authpath-auditor.git
cd authpath-auditor
python -m venv .venv
source .venv/bin/activate
python -m pip install -e '.[dev]'
pytest -q
authpath-auditor --help
```
...
Problem-space inspiration: [m14r41/PentestingEverything](https://github.com/m14r41/PentestingEverything). The reference repository was used only to understand an operational problem area and useful product ergonomics. **No source code from the reference repository is copied, vendored, or translated into this project.** The implementation, tests, CLI behavior, documentation, and project structure here are original Career Lab work.
